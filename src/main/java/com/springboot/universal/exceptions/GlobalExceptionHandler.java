package com.springboot.universal.exceptions;

import com.springboot.universal.dto.ErrorResponseDto;
...
@ControllerAdvice
@Slf4j
@Order(2) // async exception was going to SimpleAsyncUncaughtExceptionHandler...wanted it
// to come here only
